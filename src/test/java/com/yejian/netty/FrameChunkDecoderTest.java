...
import com.yejian.netty.my.chapter09.FrameChunkDecoder;
...
//创建一个 EmbeddedChannel，并向其安装一个帧大小为 3 字节的 FixedLengthFrameDecoder
        ...
        try {
            ...
            //需要注意的是，如果该类实现了 exceptionCaught()方法并处理了该异常，那么它将不会被 catch
            //块所捕获。
            System.err.println("TooLongFrameException sss");
        }
